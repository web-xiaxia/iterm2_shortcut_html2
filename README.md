...
```
1. 在iTerm2创建脚本环境
1.1. 点击菜单栏General->Magic->Enable Python API
1.2. 点击菜单栏Scripts->Manage->Install Python Runtime
1.3. 点击菜单栏Scripts->Manage->New Python Script
1.4. 在弹框中选择Full Environment->Long-Running Daemon
1.5. 选择Scripts目录中的AutoLaunch(如果没有自己创建)
1.6. 在名称框中输入iterm2_shortcut_html2
1.7. 在PyPI Dependencies中输入setup.cfg文件中的install_requires的内容
1.8. 在Python Version中选择3.7.9
1.9. 点击保存
