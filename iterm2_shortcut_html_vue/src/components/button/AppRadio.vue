...
import {type AppButtonTypeRadio, GetAppVariableRef} from "@/types/AppButton.ts";
...
const props = defineProps<ButtonProps<AppButtonTypeRadio>>();
  ...
  <div @click="handleClick" :style="buttonStyle" class="button-box handle-click">
    ...
    >
      <div style="display: flex;align-items: center">
        <input type="radio" :name="radioName" :value="v" v-model="variableInfoValue">
        {{ v }}
      </div>
    </label>
